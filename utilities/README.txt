...
gifETL4.pl                     - Perform some rudimentary checking of the gifETL2 or gifETL3 output.   Trying to resolve missing space-sections in those outputs, and section-widths not adding up to the expected 445.
